...
public class MyDBAppender extends DBAppenderBase<ILoggingEvent> {
    ...
    private static String buildInsertSQL() {
        return "insert into auto_software_service.logback_log_t (time, message, logger_level, logger_name, thread_name, caller_filename, caller_class, caller_method, caller_line) values (?, ?, ? ,?, ?, ?, ?, ?, ?)";
    }
